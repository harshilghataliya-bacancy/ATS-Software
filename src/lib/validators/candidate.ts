...
export const createCandidateSchema = z.object({
  ...
  linkedin_url: z.string().url('Please enter a valid LinkedIn URL (e.g. https://linkedin.com/in/name)').optional().nullable().or(z.literal('')),
  portfolio_url: z.string().url('Please enter a valid URL (e.g. https://example.com)').optional().nullable().or(z.literal('')),
...
export const publicApplySchema = z.object({
  ...
  email: z.string().min(1, 'Email is required').email('Please enter a valid email'),
  phone: z.string().min(1, 'Phone number is required').regex(/^\+?[\d\s\-().]{7,20}$/, 'Please enter a valid phone number'),
  linkedin_url: z.string().url('Please enter a valid LinkedIn URL (e.g. https://linkedin.com/in/name)').optional().or(z.literal('')),
  portfolio_url: z.string().url('Please enter a valid URL (e.g. https://example.com)').optional().or(z.literal('')),
