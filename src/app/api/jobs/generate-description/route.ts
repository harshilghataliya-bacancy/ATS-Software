...
Return a JSON object with exactly these fields:
{
  ...
  "description": "A detailed job description (3-5 paragraphs covering role overview, what the team does, and impact)",
  "requirements": "Bulleted list of required qualifications and responsibilities (use newlines, prefix each with •)",
  "nice_to_have": "Bulleted list of preferred qualifications (use newlines, prefix each with •)",
  "benefits": "Bulleted list of benefits and perks (use newlines, prefix each with •)",
